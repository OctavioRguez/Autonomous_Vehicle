...
if __name__=='__main__':
    ...
    red_pub = rospy.Publisher("/redFilter/raw", Image, queue_size = 60) # Publish the red filter image
    green_pub = rospy.Publisher("/greenFilter/raw", Image, queue_size = 60) # Publish the green filter image
    yellow_pub = rospy.Publisher("/yellowFilter/raw", Image, queue_size = 60) # Publish the green filter image
    color_pub = rospy.Publisher("/color", String, queue_size = 60) # Publish the color detected with the filters
